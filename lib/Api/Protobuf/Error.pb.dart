...
class Error extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Error', createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'errorno', $pb.PbFieldType.O3)
  ...
  @$pb.TagNumber(1)
  set errorno($core.int v) { $_setSignedInt32(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasErrorno() => $_has(0);
  @$pb.TagNumber(1)
  void clearErrorno() => clearField(1);
  ...
  @$pb.TagNumber(3)
  set usermsg($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasUsermsg() => $_has(2);
  @$pb.TagNumber(3)
  void clearUsermsg() => clearField(3);
}

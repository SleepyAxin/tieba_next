...
class Block 
{
  ...
  static bool _parseBody(String body) 
  {
    try 
    {
      ...
      if (code != null && code != 0) 
      {
        ...
        throw TieBaServerException(code, errorMsg);
      }
  ...
  /// 
  /// * [reason] 封禁原因
  Future<bool> request(int forumID, String portrait, int day, String reason) async 
  {
    // 特殊天数
